...
function(add_nvtest)
  ...
  cmake_parse_arguments(PARSED_ARGS "NO_DEFAULT_LINK" "NAME;COMMAND;SCRIPT" "LINK;KEYWORDS" ${ARGN})
  ...
  if(PARSED_ARGS_COMMAND)
    ...
    if(PARSED_ARGS_KEYWORDS)
      ...
      string(APPEND CONTENT "nvtest.mark.keywords(${KWDS})\n")
    endif()
    ...
    string(APPEND CONTENT "def test():\n    cmd = nvtest.Executable(\"${PARSED_ARGS_COMMAND}\")\n")
...
function(add_parallel_nvtest)
  ...
  list(JOIN ", " NPROC ${PARSED_ARGS_NPROC})
