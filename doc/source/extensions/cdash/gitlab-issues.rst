...
| Option                             | Description                                      |
+====================================+==================================================+
| ``--access-token TOKEN``           | GitLab access token [required]                   |
+------------------------------------+--------------------------------------------------+
| ``--cdash-url URL``                | Base CDash URL [required]                        |
+------------------------------------+--------------------------------------------------+
| ``--cdash-project PROJECT``        | CDash project name [required]                    |
+------------------------------------+--------------------------------------------------+
| ``--gitlab-url URL``               | GitLab project URL                               |
+------------------------------------+--------------------------------------------------+
| ``--gitlab-api-url URL``           | GitLab API URL                                  |
+------------------------------------+--------------------------------------------------+
| ``--gitlab-project-id ID``         | GitLab project ID [required]                     |
+------------------------------------+--------------------------------------------------+
| ``--date DATE``                    | Date for failures (YYYY-MM-DD)                   |
+------------------------------------+--------------------------------------------------+
| ``--filtergroups GROUPS``          | Filter groups (comma-separated)                  |
+------------------------------------+--------------------------------------------------+
| ``--skip-sites SITES``             | Skip sites (regex patterns)                      |
+------------------------------------+--------------------------------------------------+
| ``--dont-close-missing``           | Don't close issues for missing failures          |
+------------------------------------+--------------------------------------------------+
