...
.. code-block:: console
   ...
   # Inspect job status
   cat TestResults/sessions/<session>/batches/abc1234/batch.lock | jq .status
...
.. code-block:: console
   ...
   # Check resource pool
   cat TestResults/sessions/<session>/batches/abc1234/resource_pool.json | jq .
...
.. code-block:: console
   ...
   jq . TestResults/sessions/<session>/batches/abc1234/batch.lock

   # Review resource pool
   jq . TestResults/sessions/<session>/batches/abc1234/resource_pool.json
