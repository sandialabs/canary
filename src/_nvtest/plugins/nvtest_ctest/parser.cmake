...
macro(set_tests_properties NAME)
  cmake_parse_arguments(
    p
    "PROPERTIES"
    "WILL_FAIL;DISABLED;RUN_SERIAL;PROCESSOR_AFFINITY;GENERATED_RESOURCE_SPEC_FILE;PROCESSORS;TIMEOUT;TIMEOUT_SIGNAL_NAME;TIMEOUT_SIGNAL_GRACE_PERIOD;COST;SKIP_RETURN_CODE;MEASUREMENT;WORKING_DIRECTORY"
  ...
  if (p_WORKING_DIRECTORY)
    if (IS_ABSOLUTE p_WORKING_DIRECTORY)
      string(APPEND properties "${sep}{\"name\": \"WORKING_DIRECTORY\", \"value\": \"${p_WORKING_DIRECTORY}\"}")
    else()
      get_filename_component(D ${p_WORKING_DIRECTORY} ABSOLUTE BASE_DIR ${FILE_DIRECTORY})
      string(APPEND properties "${sep}{\"name\": \"WORKING_DIRECTORY\", \"value\": \"${D}\"}")
    endif()
    set(sep ", ")
  else()
