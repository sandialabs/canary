...
class Lock(object):
    ...
    def _ensure_parent_directory(self):
        ...
        try:
            ...
            # os.makedirs can fail in a number of ways when the directory
            # already exists.  With EISDIR, we know it exists, and others like
            # EEXIST, EACCES, and EROFS are fine if we ensure that the directory
            # exists.  Python 3 allows an exist_ok parameter and ignores any
            # OSError as long as the directory exists.
