...
function(add_parallel_nvtest)
  ...
  string(APPEND CONTENT "nvtest.directives.parameterize(\"cpus\", [${NPROC}])\n")
  string(APPEND CONTENT "def test():\n")
...
function(write_nvtest_config)
  ...
  file(GENERATE OUTPUT "${CMAKE_BINARY_DIR}/nvtest.yaml" CONTENT "${CONTENT}")
endfunction()
