...
from _canary.reporter import TestData
from _canary.session import Session
from _canary.test.case import TestCase
from _canary.test.case import factory as testcase_factory
from _canary.util import cdash
from _canary.util import logging
from _canary.util.filesystem import mkdirp
from _canary.util.filesystem import working_dir
from _canary.util.time import strftimestamp
from _canary.util.time import timestamp
from _canary.version import version as canary_version
...
class CDashXMLReporter:
    ...
    def validate_xml(self, file: str, *, schema: str) -> None:
        try:
            ...
            return
        dir = str(ir.files("_canary").joinpath("plugins/cdash/validators"))
