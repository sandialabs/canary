...
def test_keywords(tmpdir):
    with working_dir(tmpdir.strpath, create=True):
        with open("a.pyt", "w") as fh:
            ...
            fh.write("nvtest.directives.keywords('a', 'b', 'c')\n")
            fh.write("def test():\n")
            fh.write("    self = nvtest.get_instance()\n")
...
def test_keywords_testname(tmpdir):
    with working_dir(tmpdir.strpath, create=True):
        with open("f.pyt", "w") as fh:
            fh.write("import sys\n")
            fh.write("import nvtest\n")
            fh.write("nvtest.directives.testname('a')\n")
            fh.write("nvtest.directives.testname('b')\n")
            fh.write("nvtest.directives.keywords('kw_a', when={'testname': 'a'})\n")
            fh.write("nvtest.directives.keywords('kw_b', when='testname=\"b\"')\n")
            fh.write("def test():\n")
            fh.write("    self = nvtest.get_instance()\n")
...
def test_keywords_parameters(tmpdir):
    with working_dir(tmpdir.strpath, create=True):
        with open("f.pyt", "w") as fh:
            fh.write("import sys\n")
            fh.write("import nvtest\n")
            fh.write("nvtest.directives.parameterize('a', (2, 4, 6, 8, 10))\n")
            fh.write("nvtest.directives.keywords('kw_2', when='parameters=\"a=2\"')\n")
            fh.write("nvtest.directives.keywords('kw_4', when='parameters=\"a=4\"')\n")
            fh.write("nvtest.directives.keywords('kw_6', when='parameters=\"a>4 and a<8\"')\n")
            fh.write("nvtest.directives.keywords('kw_8', when='parameters=\"a>=7\"')\n")
            fh.write("nvtest.directives.keywords('kw_9', 'kw_10', when='parameters=\"a>8\"')\n")
            fh.write("def test():\n")
            fh.write("    self = nvtest.get_instance()\n")
