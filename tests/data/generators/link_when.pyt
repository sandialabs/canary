...
canary.directives.link(src='link_when_2.txt', dst='link_when_2-b2.txt', when={'parameters': 'a=link_when_2 and b=2'})
canary.directives.link(src='link_when_1.txt', dst='link_when_1-b2.txt', when='parameters="a=link_when_1 and b=2"')
