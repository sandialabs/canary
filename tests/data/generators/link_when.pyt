...
canary_pyt.directives.parameterize("a", ("link_when_1", "link_when_2"))
canary_pyt.directives.parameterize("b", (1, 2))
canary_pyt.directives.link("link_when_2.txt", when={"parameters": "a=link_when_2 and b=1"})
canary_pyt.directives.link("link_when_1.txt", when='parameters="a=link_when_1 and b=1"')
canary_pyt.directives.link(
