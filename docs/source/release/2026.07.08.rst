...
* Added resource directives for ``.pyt`` tests:
  * :py:func:`canary.directives.cpus`;
  * :py:func:`canary.directives.gpus`;
  * :py:func:`canary.directives.nodes`.
...
* Added :py:func:`canary.directives.artifact(..., save_on=...)` spelling for artifact save policy.
...
* Added public directive documentation for :py:func:`canary.directives.nodes`.
