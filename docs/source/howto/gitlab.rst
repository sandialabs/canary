...
In addition to reporting back to the merge request, ``nvtest`` can automatically create a :ref:`CDash <howto-cdash>` report and post a link in the merge request report.  To enable this integration, define the following variables in your runner's environment:
