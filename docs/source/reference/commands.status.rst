...
.. code-block:: console
   ...
   options:
     ...
     -o FORMAT_COLS        Comma separated list of fields to print to the screen [default: ID,Name,Session,Exit
                           Code,Duration,Status,Details]. Choices are:
                           • Name: the job name
     ...
     -r char               Show test summary info as specified by chars: (p)assed, (t)imeout (d)iffed, (f)ailed, (n)ot run,
                           (s)kipped, (a)ll (except passed), (A)ll. [default: dftns]
